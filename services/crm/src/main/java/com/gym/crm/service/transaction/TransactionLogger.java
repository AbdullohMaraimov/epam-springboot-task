...
public class TransactionLogger {
    ...
    @Before("execution(* com.gym.crm.controller..*(..))")
    ...
    @AfterReturning(value = "execution(* com.gym.crm.controller..*(..))", returning = "response")
    ...
    @AfterThrowing(value = "execution(* com.gym.crm.controller..*(..))", throwing = "exception")
